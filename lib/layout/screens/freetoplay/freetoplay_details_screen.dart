                      ...
                      FadeInRight(
                        ...
                        child: InkWell(
                          onTap: () async {
                            try {
                              await _launchUrl(
                                  Uri.parse(widget.freetoPlay.gameUrl));
                            } catch (_) {
                              ftoast.showToast(
                                  toastDuration: const Duration(seconds: 2),
                                  child: Container(
                        ...
                        children: [
                          ...
                          FadeInLeft(
                            ...
                            child: SizedBox(
                              ...
                              child: SingleChildScrollView(
                                  child: buildText(
                                      widget.freetoPlay.releaseDate, context)),
                            ),
                          ),
                        ],
                      ),
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    FadeInRight(
                                      ...
                                      curve: Curves.easeOutQuart,
                                      child:
                                          buildTitle('release date', context),
                                    ),
                                    FadeInRight(
